  ...
  return (
    <form id="product-form" action={formAction} className={styles.form}>
      ...
      <div className={styles.field}>
        ...
        <input name="business_name" className={styles.input} />
      </div>
      ...
      <div className={styles.field}>
        ...
        <textarea name="description" rows={4} className={styles.textarea} />
      </div>
      ...
      <div className={styles.field}>
        ...
        <input name="product_image_url" type="url" className={styles.input} placeholder="https://" />
      </div>
