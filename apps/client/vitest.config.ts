...
// Workspace packages aliased to TypeScript source, matching apps/web and
// apps/demo. Two projects for two environments: pure-logic `*.test.ts` in node,
// component `*.test.tsx` in jsdom. A new component test only needs the .tsx
// extension to land in the right one.
