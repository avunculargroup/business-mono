...
3. **chapters** — 3–8 chapters that divide the episode into navigable sections, in chronological order. Each has a **title** (2–5 words naming the section — a topic, not a sentence) and **start_seconds** copied from the \`[<seconds>s]\` marker where that section begins. This is a table of contents, distinct from the takeaways. If the transcript has no \`[<seconds>s]\` markers, return an empty list (a chapter with no jump target is useless).
4. **topic_tags** — 2–8 short, lowercase, hyphenated tags naming the episode's subjects (e.g. "custody", "etf", "mining", "regulation", "accounting", "macro", "self-custody"). These place the episode among related news and other episodes, so favour conventional, reusable terms over novel phrasings.
