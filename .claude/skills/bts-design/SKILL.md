...
- **Mobile:** Desktop-first but must be usable on a phone. Breakpoint `max-width: 767px`, tap targets ≥44px, no horizontal scroll at 320px, nothing reachable only by hover. Check at 375px and 320px before calling UI work done. See `README.md` → Mobile.
